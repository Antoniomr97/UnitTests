...
class ApiClientTests(unittest.TestCase):
    ...
    # Crea una variable en este script la cual podemos utilizar para agilizar el proceso
    @patch("src.api_client.requests.get")
    # Comprobamos que devuelve bien lo esperado del request
    def test_get_location_returns_expected_data(self, mock_get):
        ...
        # Comprobación de que la URL realmente existe y está funcional
    ...
    def test_get_location_returns_side_effect(self, mock_get):
        # Side_effect es una lista, tienes opciones a ejecutar
